...
dependencies {
    ...
    "testIntegrationImplementation"("org.testcontainers:testcontainers:1.18.3")

    "testIntegrationImplementation"("org.testcontainers:mariadb:1.18.3")
    "testIntegrationImplementation"("org.mariadb.jdbc:mariadb-java-client:3.2.0")

    "testIntegrationImplementation"("org.testcontainers:mongodb:1.18.3")
